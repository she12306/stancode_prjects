...
def main():
	"""
	Draw the sierpinski triangle according to the order number.
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: Decide how many times to draw three triangles.
	:param length: Side length of the triangle
	:param upper_left_x: X_origin of triangle
	:param upper_left_y: y_origin of triangle
	"""
	if order == 0:
		pass
	else:
